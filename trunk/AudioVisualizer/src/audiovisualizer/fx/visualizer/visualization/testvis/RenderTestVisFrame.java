...
public class RenderTestVisFrame implements Runnable
{
	...
	private Color[] colors = { Color.DARKVIOLET, Color.WHITE, Color.RED,
	...
	public RenderTestVisFrame(Canvas canvas, GraphicsContext gc)
	{
		this.canvas = canvas;
		this.gc = gc;
		initX.setValue (1200);
