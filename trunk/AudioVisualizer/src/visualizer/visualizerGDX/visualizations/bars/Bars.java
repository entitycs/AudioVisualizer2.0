package visualizer.visualizerGDX.visualizations.bars;
...
public abstract class Bars extends Visualization
{
	...
	public void drawBar(int i, int barNum)
	{
		...
		batch.draw(colors, i * barWidth, 0, barWidth,
				scale(avg(barNum, numSamplesPerBar)), 0, 0, 16, 5, false, false);
		// drawing top values (in red)
		batch.draw(colors, i * barWidth, scale(topValues[barNum]), barWidth, 4,
				0, 5, 16, 5, false, false);
		// drawing max values (in yellow)
		batch.draw(colors, i * barWidth, scale(maxValues[barNum]), barWidth, 2,
				0, 10, 16, 5, false, false);
